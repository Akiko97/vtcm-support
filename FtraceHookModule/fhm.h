...
#define COPY_STRINGS_KERNEL_T                                                  \
	int (*)(int, const char *const *, struct linux_binprm *)

#define QEMU_PATH "/usr/libexec/qemu-kvm"
...
static void notrace fh_ftrace_thunk(unsigned long, unsigned long,
